...
// Jaws
:MODULE JAWS jaws_X X 10*cm 10*cm 5*cm     //DIMENSIONS
0. 300. 100.*cm     // Z_FOCUS Z_TOP Z_FIELD
10*cm 10*cm     // FIELD_X_RIGHT FIELD_X_LEFT  
G4_W  expHall   // MATERIAL 
:MODULE JAWS jaws_Y Y 10*cm 10*cm 5*cm     //DIMENSIONS
0. 420. 100.*cm     // Z_FOCUS Z_TOP Z_FIELD
