...
void RTPSPDoseHistosVector::BookHistos()
{
  ...
  theAnaMgr->CreateHisto1D("RTPSPDoseHistosVector: Dose",100,doseMin,doseMax,36201);
  theAnaMgr->CreateHisto1D("RTPSPDoseHistosVector: Dose-volume",100,doseMin,doseMax,36202);
