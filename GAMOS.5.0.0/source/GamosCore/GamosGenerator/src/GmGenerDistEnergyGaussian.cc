...
G4double GmGenerDistEnergyGaussian::GenerateEnergy( const GmParticleSource* )
{
 ...
 if( GenerVerb(infoVerb) ) G4cout << " GmGenerDistEnergyGaussian::Generate energy " << ener/MeV << " MeV with mean kinetic energy = " << theMeanEnergy/MeV << " MeV and sigma = " << theSigma/MeV << " MeV "<< G4endl;
#endif
 return ener;
}
...
#ifndef GAMOS_NO_VERBOSE
  if( GenerVerb(infoVerb) ) G4cout << " GmGenerDistEnergyGaussian::SetParams theMeanEnergy = " << theMeanEnergy/MeV << " MeV and theSigma = " << theSigma/MeV << " MeV" << G4endl;
#endif
}
