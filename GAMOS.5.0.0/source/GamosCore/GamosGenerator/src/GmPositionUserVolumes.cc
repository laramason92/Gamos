...
std::vector<GVSTouchableInfo*> GmPositionUserVolumes::AddTouchableInfos( const std::vector<G4String>& params ) const
{
  ...
  if( iSolid == 6 ) {
    if( params[6] == "BOX" ){
      ...
      CheckNoSolidParams(params[6],10,params.size());
      G4VSolid* solid = new G4Tubs( "DUMMY_VOLUME", GmGenUtils::GetValue(params[7]), GmGenUtils::GetValue(params[8]), GmGenUtils::GetValue(params[9]), 0., 360.*deg );
      tinfo = AddVolume( solid, params, iSolid );
      ...
      CheckNoSolidParams(params[6],12,params.size());
      G4VSolid* solid = new G4Cons( "DUMMY_VOLUME", GmGenUtils::GetValue(params[7]), GmGenUtils::GetValue(params[8]), GmGenUtils::GetValue(params[9]), GmGenUtils::GetValue(params[10]), GmGenUtils::GetValue(params[11]), 0., 360.*deg );
      tinfo = AddVolume( solid, params, iSolid );
    ...
    if( params[1] == "BOX" ){
      ...
      CheckNoSolidParams(params[1],11,params.size());
      G4VSolid* solid = new G4Tubs( params[0], GmGenUtils::GetValue(params[8]), GmGenUtils::GetValue(params[9]), GmGenUtils::GetValue(params[10]), 0., 360.*deg );
      tinfo = AddVolume( solid, params, iSolid );
      ...
      CheckNoSolidParams(params[1],13,params.size());
      G4VSolid* solid = new G4Cons( params[0], GmGenUtils::GetValue(params[8]), GmGenUtils::GetValue(params[9]), GmGenUtils::GetValue(params[10]), GmGenUtils::GetValue(params[11]), GmGenUtils::GetValue(params[12]), 0., 360.*deg );
      tinfo = AddVolume( solid, params, iSolid );
