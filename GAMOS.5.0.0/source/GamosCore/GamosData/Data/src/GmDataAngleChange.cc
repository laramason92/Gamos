...
{
  return acos(aStep->GetPostStepPoint()->GetMomentumDirection()*aStep->GetPreStepPoint()->GetMomentumDirection())/deg;
}

//----------------------------------------------------------------
G4double GmDataAngleChange::GetValueFromTrack( const G4Track* aTrack, G4int )
{
  return acos(aTrack->GetMomentumDirection() * aTrack->GetVertexMomentumDirection())/deg;
}
...
G4double GmDataAngleChange::GetValueFromSecoTrack( const G4Track* aTrack1, const G4Track*, G4int )
{
  if( DataVerb(debugVerb) ) G4cout << " GmDataAngleChange::GetValueFromSecoTrack " 
	 << acos(aTrack1->GetStep()->GetPostStepPoint()->GetMomentumDirection()*aTrack1->GetStep()->GetPreStepPoint()->GetMomentumDirection())/deg
  ...
  return acos(aTrack1->GetStep()->GetPostStepPoint()->GetMomentumDirection()*aTrack1->GetStep()->GetPreStepPoint()->GetMomentumDirection())/deg;
}
