...
GmVChangeWorldAndSource::GmVChangeWorldAndSource() : GmUserEventAction(), GmUserStackingAction()
{
  ...
  theMinE = GmParameterMgr::GetInstance()->GetNumericValue("GmVChangeWorldAndSource:minE",1.E-12*MeV);
  theMaxE = GmParameterMgr::GetInstance()->GetNumericValue("GmVChangeWorldAndSource:maxE",1.E+2*MeV);
