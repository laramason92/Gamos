...
void GmStopRunAfterTimeUA::EndOfEventAction( const G4Event* )
{
  ...
  G4cout << UtilsUAVerb(debugVerb) << " GmStopRunAfterTimeUA::EndOfEventAction  currentTime= " << theTimer->GetUserElapsed()/ns << " Time to stop= " << theTimeToStop/ns << G4endl;
  if(  theTimer->GetUserElapsed() > theTimeToStop ) {
    G4cout << UtilsUAVerb(warningVerb) << " GmStopRunAfterTimeUA::EndOfEventAction  currentTime= " << theTimer->GetUserElapsed()/ns << " Time to stop= " << theTimeToStop/ns << G4endl;
