...
GmQGSP_BERT_HP_noHPFission::GmQGSP_BERT_HP_noHPFission():  G4VModularPhysicsList()
{
  // default cut value  (1.0mm) 
  // defaultCutValue = 1.0*mm;
  G4DataQuestionaire it(photon, neutron);
  G4cout << "<<< Geant4 Physics List simulation engine: GmQGSP_BERT_HP_noHPFission 3.0"<<G4endl;
  G4cout <<G4endl;
  ...
  // Hadron Physics
  //  G4cout << " call GmHadronPhysicsQGSP_BERT_HP_noHPFission " << G4endl;
  this->RegisterPhysics( new GmHadronPhysicsQGSP_BERT_HP_noHPFission("hadron"));
...
GmQGSP_BERT_HP_noHPFission::~GmQGSP_BERT_HP_noHPFission()
{
}

void GmQGSP_BERT_HP_noHPFission::SetCuts()
{
  if (this->verboseLevel >1){
    G4cout << "GmQGSP_BERT_HP_noHPFission::SetCuts:";
  }  
