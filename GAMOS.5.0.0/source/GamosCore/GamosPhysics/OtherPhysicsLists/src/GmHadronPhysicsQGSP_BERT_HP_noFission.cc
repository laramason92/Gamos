...
GmHadronPhysicsQGSP_BERT_HP_noFission::GmHadronPhysicsQGSP_BERT_HP_noFission(const G4String& name)
                    :  G4VPhysicsConstructor(name) 
{}

void GmHadronPhysicsQGSP_BERT_HP_noFission::CreateModels()
{
  theNeutrons=new GmNeutronBuilder_noFission;
  theNeutrons->RegisterMe(theQGSPNeutron=new G4QGSPNeutronBuilder);
  theNeutrons->RegisterMe(theLEPNeutron=new GmLEPNeutronBuilder_noFission);
  ...
  //  G4cout << " call  GmNeutronHPBuilder_noFission " << G4endl;
...
GmHadronPhysicsQGSP_BERT_HP_noFission::~GmHadronPhysicsQGSP_BERT_HP_noFission() 
{
   delete theMiscLHEP;
...
void GmHadronPhysicsQGSP_BERT_HP_noFission::ConstructParticle()
{
...
void GmHadronPhysicsQGSP_BERT_HP_noFission::ConstructProcess()
{
  CreateModels();
  theNeutrons->Build();
  thePro->Build();
