...
//---------------------------------------------------------------------------
//
// ClassName:   GmNeutronBuilder_noHPFission
//
...
//----------------------------------------------------------------------------
//
#ifndef GmNeutronBuilder_noHPFission_h
#define GmNeutronBuilder_noHPFission_h 1
...
class GmNeutronBuilder_noHPFission
{
  public: 
    GmNeutronBuilder_noHPFission();
    virtual ~GmNeutronBuilder_noHPFission();
