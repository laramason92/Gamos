...
//---------------------------------------------------------------------------
//
// ClassName:   GmLEPNeutronBuilder_noFission
//
...
//----------------------------------------------------------------------------
//
#ifndef GmLEPNeutronBuilder_noFission_h
#define GmLEPNeutronBuilder_noFission_h 1
...
class GmLEPNeutronBuilder_noFission : public G4VNeutronBuilder
{
  public: 
    GmLEPNeutronBuilder_noFission();
    virtual ~GmLEPNeutronBuilder_noFission();
