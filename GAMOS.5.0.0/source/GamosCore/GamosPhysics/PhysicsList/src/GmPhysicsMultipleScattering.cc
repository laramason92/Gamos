...
void GmPhysicsMultipleScattering::InitialiseProcess(const G4ParticleDefinition*)
{
  ...
  if( modelName == "Urban90" ) {
    mscModel = new G4UrbanMscModel90();
  }else if( modelName == "Urban93" ) {
    mscModel = new G4UrbanMscModel92();
  }else if( modelName == "Urban92" ) {
    mscModel = new G4UrbanMscModel93();
  }else if( modelName == "Urban95" ) {
    mscModel = new G4UrbanMscModel95();
  }else if( modelName == "Urban96" ) {
    mscModel = new G4UrbanMscModel96();
