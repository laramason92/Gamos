...
//
//
// $Id: G4ParticleHPInelasticData.hh,v 1.1 2012/10/02 17:20:45 arce Exp $
// GEANT4 tag $Name:  $
//
...
class G4ParticleHPInelasticData : public G4VCrossSectionDataSet
{
   public:
      ...
      G4ParticleHPInelasticData(G4ParticleDefinition* projectile = G4Neutron::Neutron(),const char* envVar = "G4NEUTRONHPDATA");
  ...
  G4ParticleDefinition* GetParticle(){return thePar;}
