...
#ifndef G4ParticleHPorLElasticModel_h
#define G4ParticleHPorLElasticModel_h 1
...
class G4ParticleHPorLElasticModel : public G4HadronicInteraction
{
   public:
      G4ParticleHPorLElasticModel();
      ~G4ParticleHPorLElasticModel();
   ...
   private: 
      ...
      G4ParticleHPorLElastic* theHPElastic;
