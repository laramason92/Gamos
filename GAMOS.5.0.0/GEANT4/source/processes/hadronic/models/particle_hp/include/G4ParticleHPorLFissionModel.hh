...
#ifndef G4ParticleHPorLFissionModel_h
#define G4ParticleHPorLFissionModel_h 1
...
class G4ParticleHPorLFissionModel : public G4HadronicInteraction
{
   public:
      G4ParticleHPorLFissionModel();
      ~G4ParticleHPorLFissionModel();
   ...
   private: 
      G4ParticleHPorLFission* theHPFission;
      G4LFission* theLFission;

      G4ParticleHPNames* theHPNames; 
};
#endif
