...
#ifndef G4ParticleHPorLEInelasticData_h
#define G4ParticleHPorLEInelasticData_h 1
...
class G4ParticleHPorLEInelasticData : public G4VCrossSectionDataSet
{
   public:
   
   G4ParticleHPorLEInelasticData();
   
   G4ParticleHPorLEInelasticData( G4ParticleHPChannelList* , std::set< G4String >* );
   ...
   private:
      G4ParticleHPChannelList* theInelasticChannel;
