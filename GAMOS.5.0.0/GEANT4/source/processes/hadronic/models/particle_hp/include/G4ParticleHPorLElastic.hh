...
#ifndef G4ParticleHPorLElastic_h
#define G4ParticleHPorLElastic_h 1
...
class G4ParticleHPorLElastic : public G4HadronicInteraction
{
  public: 
  
  G4ParticleHPorLElastic();
  ...
  G4bool overrideSuspension;
   ...
   private:
      G4ParticleHPorLElasticData* theDataSet;
