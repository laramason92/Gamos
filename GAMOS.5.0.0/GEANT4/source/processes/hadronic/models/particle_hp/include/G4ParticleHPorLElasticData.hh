...
#ifndef G4ParticleHPorLElasticData_h
#define G4ParticleHPorLElasticData_h 1
...
class G4ParticleHPorLElasticData : public G4VCrossSectionDataSet
{
   public:
   
   G4ParticleHPorLElasticData();
   
   G4ParticleHPorLElasticData( G4ParticleHPChannel* , std::set< G4String >* );
   ...
   private:
     G4ParticleHPChannel* theElasticChannel;
