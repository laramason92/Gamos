...
//
//
// $Id: G4ParticleHPPhotonXSection.hh,v 1.1 2012/10/02 17:20:53 arce Exp $
// GEANT4 tag $Name:  $
//
#ifndef G4ParticleHPPhotonXSection_h
#define G4ParticleHPPhotonXSection_h 1
...
class G4ParticleHPPhotonXSection 
{
  public:
  G4ParticleHPPhotonXSection()
  {
    theExclusive = 0;
    theExShell = 0;
    theExEnergy = 0;
  ...
  inline void Init(std::ifstream & aDataFile)
  {
    ...
    theExclusive = new G4ParticleHPVector[nChannels];
  ...
  G4int theIncFlag
  G4int theIncDisFlag;
  G4ParticleHPVector theInclusive;
  ...
  G4int * theExFlag
  G4int * theExDisFlag;
  G4ParticleHPVector * theExclusive;
