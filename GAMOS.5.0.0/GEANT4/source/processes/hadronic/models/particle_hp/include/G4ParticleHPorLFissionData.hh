...
#ifndef G4ParticleHPorLFissionData_h
#define G4ParticleHPorLFissionData_h 1
...
class G4ParticleHPorLFissionData : public G4VCrossSectionDataSet
{
   public:
   
   G4ParticleHPorLFissionData();
   
   G4ParticleHPorLFissionData( G4ParticleHPChannel* , std::set< G4String >* );
   ...
   private:
     G4ParticleHPChannel* theFissionChannel;
