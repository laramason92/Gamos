...
#ifndef G4ParticleHPorLCaptureModel_h
#define G4ParticleHPorLCaptureModel_h 1
...
class G4ParticleHPorLCaptureModel : public G4HadronicInteraction
{
   public:
      G4ParticleHPorLCaptureModel();
      ~G4ParticleHPorLCaptureModel();
   ...
   private: 
      G4ParticleHPorLCapture* theHPCapture;
