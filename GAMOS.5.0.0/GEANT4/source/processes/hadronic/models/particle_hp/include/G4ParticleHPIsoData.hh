...
//
//
// $Id: G4ParticleHPIsoData.hh,v 1.1 2012/10/02 17:20:45 arce Exp $
// GEANT4 tag $Name:  $
//
...
public:
  ...
  G4bool Init(G4int A, G4int Z, G4double abun, G4String dirName, G4String aFSType, G4String dataDirVariable){ G4int M = 0 ; return Init( A, Z, M, abun, dirName, aFSType, dataDirVariable); };
  G4bool Init(G4int A, G4int Z, G4int M, G4double abun, G4String dirName, G4String aFSType, G4String dataDirVariable);
