...
#ifndef G4ParticleHPorLCapture_h
#define G4ParticleHPorLCapture_h 1
...
class G4ParticleHPorLCapture : public G4HadronicInteraction
{
  public: 
  
  G4ParticleHPorLCapture();
  ...
  G4int numEle;
   ...
   private:
      G4ParticleHPorLCaptureData* theDataSet;
