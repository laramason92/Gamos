...
#ifndef G4ParticleHPorLEInelasticModel_h
#define G4ParticleHPorLEInelasticModel_h 1
...
class G4ParticleHPorLEInelasticModel : public G4HadronicInteraction
{
   public:
      G4ParticleHPorLEInelasticModel();
      ~G4ParticleHPorLEInelasticModel();
   ...
   private: 
      ...
      G4ParticleHPorLEInelastic* theHPInelastic;
