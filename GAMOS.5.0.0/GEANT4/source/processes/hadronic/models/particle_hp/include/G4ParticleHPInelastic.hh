...
//
//
// $Id: G4ParticleHPInelastic.hh,v 1.1 2012/10/02 17:20:44 arce Exp $
// GEANT4 tag $Name:  $
//
...
class G4ParticleHPInelastic : public G4HadronicInteraction
{
  ...
  G4ParticleHPInelastic(G4ParticleDefinition* projectile = G4Neutron::Neutron(), const G4String& dataDirVariable = "G4NEUTRONHPDATA", const G4String& name = "NeutronHPInelastic" );
  ...
  void SetDataDirVariable(const G4String& ddir );
