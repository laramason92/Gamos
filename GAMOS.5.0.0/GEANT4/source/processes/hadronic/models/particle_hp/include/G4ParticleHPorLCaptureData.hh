...
#ifndef G4ParticleHPorLCaptureData_h
#define G4ParticleHPorLCaptureData_h 1
...
class G4ParticleHPorLCaptureData : public G4VCrossSectionDataSet
{
   public:
   
   G4ParticleHPorLCaptureData();
   
   G4ParticleHPorLCaptureData( G4ParticleHPChannel* , std::set< G4String >* );
   ...
   private:
     G4ParticleHPChannel* theCaptureChannel;
