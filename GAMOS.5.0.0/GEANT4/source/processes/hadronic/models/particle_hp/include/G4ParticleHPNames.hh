...
//
//
// $Id: G4ParticleHPNames.hh,v 1.1 2012/10/02 17:20:50 arce Exp $
// GEANT4 tag $Name:  $
//
...
class G4ParticleHPNames
{
  ...
  G4ParticleHPDataUsed GetName(G4int A, G4int Z, G4String base, G4String rest, G4bool & active, G4String dataDirVariable) { G4int M = 0; return GetName( A, Z, M, base, rest, active, dataDirVariable); };
  G4ParticleHPDataUsed GetName(G4int A, G4int Z, G4int M, G4String base, G4String rest, G4bool & active, G4String dataDirVariable);
