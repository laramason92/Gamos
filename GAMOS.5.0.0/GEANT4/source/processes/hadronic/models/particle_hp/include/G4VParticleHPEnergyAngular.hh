...
//
//
// $Id: G4VParticleHPEnergyAngular.hh,v 1.1 2012/10/02 17:20:58 arce Exp $
// GEANT4 tag $Name:  $
//
...
class G4VParticleHPEnergyAngular
{
  ...
  void SetIncidentParticle(G4ReactionProduct * aIncidentParticle) 
  { 
    theIncidentParticle = aIncidentParticle; 
    if(theTarget!=0) theCMS = *theIncidentParticle+*theTarget;
  }
  ...
  G4ReactionProduct * GetIncidentParticle() { return theIncidentParticle; }
