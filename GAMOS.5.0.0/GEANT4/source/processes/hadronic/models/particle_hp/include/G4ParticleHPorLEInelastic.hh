...
#ifndef G4ParticleHPorLEInelastic_h
#define G4ParticleHPorLEInelastic_h 1
...
class G4ParticleHPorLEInelastic : public G4HadronicInteraction
{
  public: 
  
  G4ParticleHPorLEInelastic(G4ParticleDefinition* projectile = G4Neutron::Neutron(), const G4String& dataDir = "G4NEUTRONHPDATA" );
  
  ~G4ParticleHPorLEInelastic();
  
  G4HadFinalState * ApplyYourself(const G4HadProjectile& aTrack, G4Nucleus& aTargetNucleus);

  void SetProjectile( G4ParticleDefinition* part );
  ...
  G4double * xSec;
  G4ParticleHPChannelList * theInelastic;
  G4String dirName;
  G4int numEle;
   ...
   private:
      G4ParticleHPorLEInelasticData* theDataSet;
