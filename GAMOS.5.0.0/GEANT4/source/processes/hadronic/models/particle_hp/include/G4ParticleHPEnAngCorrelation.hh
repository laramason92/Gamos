...
//
//
// $Id: G4ParticleHPEnAngCorrelation.hh,v 1.1 2012/10/02 17:20:41 arce Exp $
// GEANT4 tag $Name:  $
//
...
class G4ParticleHPEnAngCorrelation
{
  ...
  inline void Init(std::ifstream & aDataFile)
  {
    ...
    const char* ctmp = getenv("G4PARTICLEHP_DO_NOT_ADJUST_FINAL_STATE");
  ...
  inline void SetIncidentParticle(G4ReactionProduct & aIncidentPart)
  {
    theIncidentPart = aIncidentPart;
    for(G4int i=0;i<nProducts;i++)theProducts[i].SetIncidentPart(&theIncidentPart);
  }
