...
#ifndef G4ParticleHPorLFission_h
#define G4ParticleHPorLFission_h 1
...
class G4ParticleHPorLFission : public G4HadronicInteraction
{
   public: 
      G4ParticleHPorLFission();
      ~G4ParticleHPorLFission();
   ...
   private:
      G4ParticleHPorLFissionData* theDataSet;
