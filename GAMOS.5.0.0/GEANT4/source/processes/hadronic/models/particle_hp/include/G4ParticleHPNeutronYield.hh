...
//
//
// $Id: G4ParticleHPNeutronYield.hh,v 1.1 2012/10/02 17:20:50 arce Exp $
// GEANT4 tag $Name:  $
//
#ifndef G4ParticleHPNeutronYield_h
#define G4ParticleHPNeutronYield_h 1
...
class G4ParticleHPNeutronYield
{
  public:
  G4ParticleHPNeutronYield()
  {
    simpleMean = true;
    spontPrompt = true;
    hasPromptData = false;
