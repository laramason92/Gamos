...
// prepare neutron
   ...
   const G4HadProjectile *neutron = &theTrack;
   G4ReactionProduct theNeutron( const_cast<G4ParticleDefinition *>(neutron->GetDefinition()) );
   theNeutron.SetMomentum( neutron->Get4Momentum().vect() );
...
// prepare target
   ...
   G4ThreeVector neuVelo = (1./neutron->GetDefinition()->GetPDGMass())*theNeutron.GetMomentum();
