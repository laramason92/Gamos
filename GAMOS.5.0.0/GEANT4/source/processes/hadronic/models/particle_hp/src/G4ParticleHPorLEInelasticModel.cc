...
#include "G4ParticleHPorLEInelasticModel.hh"

G4ParticleHPorLEInelasticModel::G4ParticleHPorLEInelasticModel()
{
   //theHPElastic = new G4ParticleHPElastic();
   theHPInelastic = new G4ParticleHPorLEInelastic();
   theLEInelastic = new G4LENeutronInelastic();
   theHPNames = new G4ParticleHPNames();
}
G4ParticleHPorLEInelasticModel::~G4ParticleHPorLEInelasticModel()
{
...
G4HadFinalState* G4ParticleHPorLEInelasticModel::ApplyYourself(const G4HadProjectile& aTrack, G4Nucleus& aTargetNucleus)
{
