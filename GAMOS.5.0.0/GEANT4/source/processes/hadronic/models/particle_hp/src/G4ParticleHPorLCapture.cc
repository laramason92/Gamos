...
//
#include "G4ParticleHPorLCapture.hh"
#include "G4ParticleHPCaptureFS.hh"

G4ParticleHPorLCapture::G4ParticleHPorLCapture()
...
//    G4cout <<"G4ParticleHPorLCapture::G4ParticleHPorLCapture testit "<<dirName<<G4endl;
...
G4HadFinalState * G4ParticleHPorLCapture::ApplyYourself(const G4HadProjectile& aTrack, G4Nucleus& )
{
...
G4bool G4ParticleHPorLCapture::IsThisElementOK( G4String name )
{
...
void G4ParticleHPorLCapture::createXSectionDataSet()
{
   theDataSet = new G4ParticleHPorLCaptureData ( theCapture , &unavailable_elements );
}
