...
#include "G4ParticleHPorLElasticData.hh"
...
G4ParticleHPorLElasticData::G4ParticleHPorLElasticData()
{
...
G4bool G4ParticleHPorLElasticData::IsIsoApplicable( const G4DynamicParticle* dp , 
                                                G4int /*Z*/ , G4int /*A*/ ,
...
G4double G4ParticleHPorLElasticData::GetIsoCrossSection( const G4DynamicParticle* dp ,
                                   G4int /*Z*/ , G4int /*A*/ ,
                                   const G4Isotope* /*iso*/  ,
                                   const G4Element* element ,
...
G4ParticleHPorLElasticData::G4ParticleHPorLElasticData( G4ParticleHPChannel* pChannel , std::set< G4String >* pSet )
...
/*
G4bool G4ParticleHPorLElasticData::IsApplicable(const G4DynamicParticle*aP, const G4Element* anElement)
{
   G4bool result = true;
...
void G4ParticleHPorLElasticData::BuildPhysicsTable( const G4ParticleDefinition& aP )
{
...
void G4ParticleHPorLElasticData::DumpPhysicsTable(const G4ParticleDefinition& aP)
{
  if(&aP!=G4Neutron::Neutron()) 
     throw G4HadronicException(__FILE__, __LINE__, "Attempt to use NeutronHP data for particles other than neutrons!!!");  
//  G4cout << "G4ParticleHPorLElasticData::DumpPhysicsTable still to be implemented"<<G4endl;
}
...
G4double G4ParticleHPorLElasticData::
GetCrossSection(const G4DynamicParticle* aP, const G4Element*anE, G4double aT)
{

  //G4cout << "Choice G4ParticleHPorLElasticData for element " << anE->GetName() << G4endl;
  G4double result = 0;
//  G4bool outOfRange;
