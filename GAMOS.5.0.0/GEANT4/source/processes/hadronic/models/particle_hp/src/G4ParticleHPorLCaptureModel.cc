...
#include "G4ParticleHPorLCaptureModel.hh"

G4ParticleHPorLCaptureModel::G4ParticleHPorLCaptureModel()
{
   theHPCapture = new G4ParticleHPorLCapture();
...
G4HadFinalState* G4ParticleHPorLCaptureModel::ApplyYourself(const G4HadProjectile& aTrack, G4Nucleus& aTargetNucleus)
{
