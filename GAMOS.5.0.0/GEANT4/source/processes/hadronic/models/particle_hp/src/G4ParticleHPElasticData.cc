...
//080428
   if ( getenv( "G4PARTICLEHP_DOPPLER_LOOP_ONCE" ) ) 
   {
      G4cout << "Find environment variable of \"G4PARTICLEHP_DOPPLER_LOOP_ONCE\"." << G4endl;
...
// TKDB
  ...
  for( size_t i=0; i<numberOfElements; ++i )
  {
    G4PhysicsVector* physVec = G4ParticleHPData::
      Instance(G4Neutron::Neutron(),"G4NEUTRONHPDATA")->MakePhysicsVector((*theElementTable)[i], this);
...
//080428
  ...
  result /= counter;
/*
  // Checking impact of  G4PARTICLEHP_DOPPLER_LOOP_ONCE
