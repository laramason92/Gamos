...
#include "G4ParticleHPorLCaptureData.hh"
...
G4ParticleHPorLCaptureData::G4ParticleHPorLCaptureData()
{
...
G4bool G4ParticleHPorLCaptureData::IsIsoApplicable( const G4DynamicParticle* dp , 
                                                G4int /*Z*/ , G4int /*A*/ ,
...
G4double G4ParticleHPorLCaptureData::GetIsoCrossSection( const G4DynamicParticle* dp ,
                                   G4int /*Z*/ , G4int /*A*/ ,
                                   const G4Isotope* /*iso*/  ,
                                   const G4Element* element ,
...
G4ParticleHPorLCaptureData::G4ParticleHPorLCaptureData( G4ParticleHPChannel* pChannel , std::set< G4String >* pSet )
:G4VCrossSectionDataSet("NeutronHPorLCaptureXS")
{
...
/*
G4bool G4ParticleHPorLCaptureData::IsApplicable(const G4DynamicParticle*aP, const G4Element* anElement)
{
   G4bool result = true;
...
void G4ParticleHPorLCaptureData::BuildPhysicsTable( const G4ParticleDefinition& aP )
{
...
void G4ParticleHPorLCaptureData::DumpPhysicsTable(const G4ParticleDefinition& aP)
{
  if(&aP!=G4Neutron::Neutron()) 
     throw G4HadronicException(__FILE__, __LINE__, "Attempt to use NeutronHP data for particles other than neutrons!!!");  
//  G4cout << "G4ParticleHPorLCaptureData::DumpPhysicsTable still to be implemented"<<G4endl;
}
...
G4double G4ParticleHPorLCaptureData::
GetCrossSection(const G4DynamicParticle* aP, const G4Element*anE, G4double aT)
{

  // G4cout << "Choice G4ParticleHPorLCaptureData for element " << anE->GetName() << G4endl;
  G4double result = 0;
//  G4bool outOfRange;
