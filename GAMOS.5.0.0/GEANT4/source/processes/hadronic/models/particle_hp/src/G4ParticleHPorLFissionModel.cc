...
#include "G4ParticleHPorLFissionModel.hh"

G4ParticleHPorLFissionModel::G4ParticleHPorLFissionModel()
{
   theHPFission = new G4ParticleHPorLFission();
...
G4HadFinalState* G4ParticleHPorLFissionModel::ApplyYourself(const G4HadProjectile& aTrack, G4Nucleus& aTargetNucleus)
{
