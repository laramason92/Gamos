...
#include "G4ParticleHPorLEInelasticData.hh"
...
G4ParticleHPorLEInelasticData::G4ParticleHPorLEInelasticData()
{
...
G4bool G4ParticleHPorLEInelasticData::IsIsoApplicable( const G4DynamicParticle* dp , 
                                                G4int /*Z*/ , G4int /*A*/ ,
...
G4double G4ParticleHPorLEInelasticData::GetIsoCrossSection( const G4DynamicParticle* dp ,
                                   G4int /*Z*/ , G4int /*A*/ ,
                                   const G4Isotope* /*iso*/  ,
                                   const G4Element* element ,
...
G4ParticleHPorLEInelasticData::G4ParticleHPorLEInelasticData( G4ParticleHPChannelList* pChannel , std::set< G4String >* pSet )
...
/*
G4bool G4ParticleHPorLEInelasticData::IsApplicable(const G4DynamicParticle*aP, const G4Element* anElement)
{
   G4bool result = true;
...
void G4ParticleHPorLEInelasticData::BuildPhysicsTable( const G4ParticleDefinition& aP )
{
   ...
   for ( size_t i=0 ; i < numberOfElements; ++i )
   {
      ...
      { 
         ...
         G4ParticleHPElementData* theElementData = new G4ParticleHPElementData();
         theElementData->Init( (*theElementTable)[i], G4Neutron::Neutron(), "G4NEUTRONHPDATA" );  

         G4ParticleHPVector* theHPVector = theElementData->GetData( (G4ParticleHPInelasticData*)this ); 
...
void G4ParticleHPorLEInelasticData::DumpPhysicsTable(const G4ParticleDefinition& aP)
{
  if(&aP!=G4Neutron::Neutron()) 
     throw G4HadronicException(__FILE__, __LINE__, "Attempt to use NeutronHP data for particles other than neutrons!!!");  
//  G4cout << "G4ParticleHPorLEInelasticData::DumpPhysicsTable still to be implemented"<<G4endl;
}
...
G4double G4ParticleHPorLEInelasticData::
GetCrossSection(const G4DynamicParticle* aP, const G4Element*anE, G4double aT)
{

  // G4cout << "Choice G4ParticleHPorLEInelasticData for element " << anE->GetName() << G4endl;
  G4double result = 0;
  //G4bool outOfRange;
