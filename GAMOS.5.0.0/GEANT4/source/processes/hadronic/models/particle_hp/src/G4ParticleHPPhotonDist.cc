...
G4bool G4ParticleHPPhotonDist::InitMean(std::ifstream & aDataFile)
{
...
void G4ParticleHPPhotonDist::InitAngular(std::ifstream & aDataFile)
{
...
void G4ParticleHPPhotonDist::InitEnergies(std::ifstream & aDataFile)
{
...
void G4ParticleHPPhotonDist::InitPartials(std::ifstream & aDataFile)
{
