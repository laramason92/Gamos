...
#include "G4ParticleHPorLFissionData.hh"
...
G4ParticleHPorLFissionData::G4ParticleHPorLFissionData()
{
...
G4bool G4ParticleHPorLFissionData::IsIsoApplicable( const G4DynamicParticle* dp , 
                                                G4int /*Z*/ , G4int /*A*/ ,
...
G4double G4ParticleHPorLFissionData::GetIsoCrossSection( const G4DynamicParticle* dp ,
                                   G4int /*Z*/ , G4int /*A*/ ,
                                   const G4Isotope* /*iso*/  ,
                                   const G4Element* element ,
...
G4ParticleHPorLFissionData::G4ParticleHPorLFissionData( G4ParticleHPChannel* pChannel , std::set< G4String >* pSet )
...
/*
G4bool G4ParticleHPorLFissionData::IsApplicable(const G4DynamicParticle*aP, const G4Element* anElement)
{
   G4bool result = true;
...
void G4ParticleHPorLFissionData::BuildPhysicsTable( const G4ParticleDefinition& aP )
{
...
void G4ParticleHPorLFissionData::DumpPhysicsTable(const G4ParticleDefinition& aP)
{
  if(&aP!=G4Neutron::Neutron()) 
     throw G4HadronicException(__FILE__, __LINE__, "Attempt to use NeutronHP data for particles other than neutrons!!!");  
//  G4cout << "G4ParticleHPorLFissionData::DumpPhysicsTable still to be implemented"<<G4endl;
}
...
G4double G4ParticleHPorLFissionData::
