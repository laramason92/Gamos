...
#include "G4ParticleHPorLElasticModel.hh"

G4ParticleHPorLElasticModel::G4ParticleHPorLElasticModel()
{
   //theHPElastic = new G4ParticleHPElastic();
   theHPElastic = new G4ParticleHPorLElastic();
...
G4HadFinalState* G4ParticleHPorLElasticModel::ApplyYourself(const G4HadProjectile& aTrack, G4Nucleus& aTargetNucleus)
{
