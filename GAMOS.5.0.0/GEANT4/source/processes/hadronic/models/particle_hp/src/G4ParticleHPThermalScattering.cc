...
E_P_E_isoAng* G4ParticleHPThermalScattering::readAnE_P_E_isoAng( std::ifstream* file )
{
...
E_isoAng* G4ParticleHPThermalScattering::readAnE_isoAng( std::ifstream* file )
{
...
{ 
   ...
   if ( High.first - Low.first != 0 ) 
      ...
      std::cout << "G4ParticleHPThermalScattering liner interpolation err!!" << std::endl; 
