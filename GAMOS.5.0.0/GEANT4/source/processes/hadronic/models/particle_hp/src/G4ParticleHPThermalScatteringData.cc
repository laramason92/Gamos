...
void G4ParticleHPThermalScatteringData::BuildPhysicsTable(const G4ParticleDefinition& aP)
{
   ...
   for ( std::map < G4String , G4int >::iterator it = co_dic.begin() ; it != co_dic.end() ; it++ )  
   {
      ...
      std::map< G4double , G4ParticleHPVector* >*  coh_amapTemp_EnergyCross = readData( name );
      ...
      std::map< G4double , G4ParticleHPVector* >*  incoh_amapTemp_EnergyCross = readData( name );
      ...
      std::map< G4double , G4ParticleHPVector* >*  inela_amapTemp_EnergyCross = readData( name );
...
std::map< G4double , G4ParticleHPVector* >* G4ParticleHPThermalScatteringData::readData ( G4String name ) 
{
