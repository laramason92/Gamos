...
//
#include "G4ParticleHPorLFission.hh"
#include "G4ParticleHPFissionFS.hh"

G4ParticleHPorLFission::G4ParticleHPorLFission()
...
//    G4cout <<"G4ParticleHPorLFission::G4ParticleHPorLFission testit "<<dirName<<G4endl;
...
G4HadFinalState * G4ParticleHPorLFission::ApplyYourself(const G4HadProjectile& aTrack, G4Nucleus& )
{
...
G4bool G4ParticleHPorLFission::IsThisElementOK( G4String name )
{
...
void G4ParticleHPorLFission::createXSectionDataSet()
{
   theDataSet = new G4ParticleHPorLFissionData ( theFission , &unavailable_elements );
}
