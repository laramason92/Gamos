...
*/
#include <stdio.h>
#include <ctype.h> // for isspace,isascii,tolower
#include <string.h>
#include <stdlib.h>
#include <math.h>  // for round, power
...
int writeBigEndianBinaryFile(char *binaryFileName,  int nItemsToWrite, float *arrayToWrite)
{
   ...
   {
     printf("\n ERROR: Writing dose file %", binaryFileName); return(FAIL);
   }
   return(OK);
} 
/* ***************************************************************************************************** */
...
/* ***************************************************************************************************** */
char *strnset(char *s, int ch, unsigned int n)
